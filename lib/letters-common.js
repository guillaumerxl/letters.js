...
/***/ function(module, exports) {
	...
	var Letters = function () {
	  function Letters() {
	    ...
	    var container = arguments.length <= 1 || arguments[1] === undefined ? document.body : arguments[1];
	      ...
	      if (ts) {
	        ...
	        for (var i = 0; i < this.wordsCount; i++) {
	          ...
	          if (single) {
	            ...
	            if (!stopped) {
	              var alphabet = this.options.mode == "shuffle" ? this.shuffle(word.split("")) : this.getSomeLetters(name.length);
